    ...
    bool is_open = false;
      ...
      is_open = Large[K].is_open;
          ...
          if (i == j) {
            ...
            if (is_open) E1 += oG[K](i, i)*Dens.cLL[K](i, i);
          } else {
            E0 += 2*I[K](i, j)*Dens.cLL[K](i, j);
            E1 += 2*cG[K](i, j)*Dens.cLL[K](i, j);
            if (is_open) E1 += 2*oG[K](i, j)*Dens.cLL[K](i, j);
          }
				}
			}
      ...
      for (int i2 = 0; i2 < Dim[K2]; i2++) {
        for (int j2 = i2; j2 < Dim[K2]; j2++) {
          ...
          if (i2 == j2) {
            ...
            oG[K1](i1+Dim[K1], j1+Dim[K1]) += Dens.oSS[K2](i2, j2) * eABss + Dens.oLL[K2](i2, j2) * eABsl;
          } else {
            cG[K1](i1, j1) += 2*(Dens.cLL[K2](i2, j2) * eABll + Dens.cSS[K2](i2, j2) * eABls);
            cG[K1](i1+Dim[K1], j1+Dim[K1]) += 2 * (Dens.cSS[K2](i2, j2) * eABss + Dens.cLL[K2](i2, j2) * eABsl);
						oG[K1](i1, j1) += 2*(Dens.oLL[K2](i2, j2) * eABll + Dens.oSS[K2](i2, j2) * eABls);
            oG[K1](i1+Dim[K1], j1+Dim[K1]) += 2 * (Dens.oSS[K2](i2, j2) * eABss + Dens.oLL[K2](i2, j2) * eABsl);
          }
          ...
          if (i1 == j1) {
            ...
            oG[K2](i2+Dim[K2], j2+Dim[K2]) += Dens.oSS[K1](i1, j1) * eABss + Dens.oLL[K1](i1, j1) * eABls;
          } else {
            cG[K2](i2, j2) += 2 * (Dens.cLL[K1](i1, j1) * eABll + Dens.cSS[K1](i1,j1) * eABsl);
            cG[K2](i2+Dim[K2], j2+Dim[K2]) += 2 * (Dens.cSS[K1](i1, j1) * eABss + Dens.cLL[K1](i1, j1) * eABls);
						oG[K2](i2, j2) += 2 * (Dens.oLL[K1](i1, j1) * eABll + Dens.oSS[K1](i1,j1) * eABsl);
            oG[K2](i2+Dim[K2], j2+Dim[K2]) += 2 * (Dens.oSS[K1](i1, j1) * eABss + Dens.oLL[K1](i1, j1) * eABls);
          }
        }
      }
    }
    ...
    for (int j1 = 0; j1 < Dim[K1]; j1++) {
      ...
      for (int i2 = 0; i2 < Dim[K2]; i2++) {
        for (int j2 = 0; j2 < Dim[K2]; j2++) {
          ...
          cG[K1](i1, j1+Dim[K1]) += Dens.cLS[K2](j2, i2) * eABls;
					oG[K1](i1, j1+Dim[K1]) += Dens.oLS[K2](j2, i2) * eABls;
          if (K1 != K2) {
						cG[K2](j2, i2+Dim[K2]) += Dens.cLS[K1](i1, j1) * eABls;
						oG[K2](j2, i2+Dim[K2]) += Dens.oLS[K1](i1, j1) * eABls;
					}
        }
      }
      //R(LLLL) & R(SSSS) - non-relativistic symmetries.
      ...
      for (int i2 = 0; i2 < Dim[K2]; i2++) {
        for (int j2 = 0; j2 < Dim[K2]; j2++) {
          ...
          if (i1 <= j1) {
            ...
            oG[K1](i1+Dim[K1], j1+Dim[K1]) += Dens.oSS[K2](i2, j2) * eABss;
          }								
          if (i2 <= j2 && K1 != K2) {
            cG[K2](i2, j2) += Dens.cLL[K1](i1, j1) * eABll;
            cG[K2](i2+Dim[K2], j2+Dim[K2]) += Dens.cSS[K1](i1, j1) * eABss;
						oG[K2](i2, j2) += Dens.oLL[K1](i1, j1) * eABll;
            oG[K2](i2+Dim[K2], j2+Dim[K2]) += Dens.oSS[K1](i1, j1) * eABss;
          }
        }
      }
    }
